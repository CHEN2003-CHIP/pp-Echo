...
function ChatWorkspace({ transcriptRef, transcript, activeSnapshot, workspace, workspaceStatus, activeModel, activeSessionId, displayStatus, busy, prompt, promptSubmitting, activeApproval, setPrompt, sendPrompt, cancelActiveSession, activityItems, approvalSummary, approvalAction, approvalFeedback, attachments, attachmentUploading, approve, reject, refreshAttachments, uploadAttachment, deleteAttachment, openAttachments, inspectorTab, setInspectorTab, activeEvents, notice, inspectorOpen, setInspectorOpen, onWorkspaceChanged, onModelChanged }) {
    ...
    const turnMarkers = (0, react_1.useMemo)(() => buildTurnMarkers(transcript), [transcript]);
...
function UsagePanel() {
    ...
    const lineSeries = rows.map((row, index) => ({
        provider_id: row.provider_id,
        model: row.model,
        points: [
            { date: 'day-1', total_tokens: Math.max(0, row.total_tokens - row.input_tokens) },
            { date: 'day-2', total_tokens: row.input_tokens },
            { date: 'day-3', total_tokens: row.output_tokens }
        ],
        color: USAGE_COLORS[index % USAGE_COLORS.length]
    }));
    const timeline = [
        { date: 'day-1', label: 'D-2' },
        { date: 'day-2', label: 'D-1' },
        { date: 'day-3', label: 'Today' }
    ];
    return ((0, jsx_runtime_1.jsxs)("section", { className: "space-y-4 p-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-start justify-between gap-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "space-y-1", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-xs font-medium uppercase tracking-wide text-muted-foreground", children: "Model Usage" }), (0, jsx_runtime_1.jsx)("h2", { className: "text-xl font-semibold tracking-tight", children: "Usage dashboard" }), (0, jsx_runtime_1.jsx)("p", { className: "text-sm text-muted-foreground", children: "Model distribution, token trends, and provider coverage." })] }), (0, jsx_runtime_1.jsxs)(button_1.Button, { variant: "outline", size: "sm", onClick: loadUsage, disabled: loading, children: [(0, jsx_runtime_1.jsx)(lucide_react_1.RefreshCw, { size: 14 }), "Refresh"] })] }), error ? ((0, jsx_runtime_1.jsxs)(alert_1.Alert, { variant: "destructive", children: [(0, jsx_runtime_1.jsx)(alert_1.AlertTitle, { children: "Usage load failed" }), (0, jsx_runtime_1.jsx)(alert_1.AlertDescription, { children: error })] })) : null, (0, jsx_runtime_1.jsxs)("div", { className: "grid gap-3 md:grid-cols-5", children: [(0, jsx_runtime_1.jsx)(UsageMetricCard, { label: "Configured", value: `${configuredCount}/${rows.length}` }), (0, jsx_runtime_1.jsx)(UsageMetricCard, { label: "Runs", value: totals.runs }), (0, jsx_runtime_1.jsx)(UsageMetricCard, { label: "LLM Calls", value: totals.calls }), (0, jsx_runtime_1.jsx)(UsageMetricCard, { label: "Tokens", value: totals.tokens.toLocaleString() }), (0, jsx_runtime_1.jsx)(UsageMetricCard, { label: "Cost", value: totals.cost ? `$${totals.cost.toFixed(6)}` : 'N/A' })] }), (0, jsx_runtime_1.jsxs)("div", { className: "grid gap-4 xl:grid-cols-2", children: [(0, jsx_runtime_1.jsx)(card_1.Card, { children: (0, jsx_runtime_1.jsxs)(card_1.CardContent, { className: "space-y-4 p-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { className: "text-base font-semibold", children: "Model distribution" }), (0, jsx_runtime_1.jsx)("p", { className: "text-sm text-muted-foreground", children: "Share by total tokens." })] }), (0, jsx_runtime_1.jsxs)(badge_1.Badge, { variant: "outline", children: [modelShare.length, " models"] })] }), loading ? (0, jsx_runtime_1.jsx)(ChartSkeleton, {}) : (0, jsx_runtime_1.jsx)(DonutChart, { share: modelShare })] }) }), (0, jsx_runtime_1.jsx)(card_1.Card, { children: (0, jsx_runtime_1.jsxs)(card_1.CardContent, { className: "space-y-4 p-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { className: "text-base font-semibold", children: "Token trend" }), (0, jsx_runtime_1.jsx)("p", { className: "text-sm text-muted-foreground", children: "Sampled token usage across models." })] }), (0, jsx_runtime_1.jsxs)(badge_1.Badge, { variant: "outline", children: [timeline.length, " points"] })] }), loading ? (0, jsx_runtime_1.jsx)(ChartSkeleton, {}) : (0, jsx_runtime_1.jsx)(UsageLineChart, { series: lineSeries, timeline: timeline })] }) })] }), (0, jsx_runtime_1.jsx)(card_1.Card, { children: (0, jsx_runtime_1.jsx)(card_1.CardContent, { className: "p-0", children: loading ? ((0, jsx_runtime_1.jsxs)("div", { className: "space-y-3 p-4", children: [(0, jsx_runtime_1.jsx)(skeleton_1.Skeleton, { className: "h-5 w-56" }), (0, jsx_runtime_1.jsx)(skeleton_1.Skeleton, { className: "h-10 w-full" }), (0, jsx_runtime_1.jsx)(skeleton_1.Skeleton, { className: "h-10 w-full" }), (0, jsx_runtime_1.jsx)(skeleton_1.Skeleton, { className: "h-10 w-full" })] })) : rows.length ? ((0, jsx_runtime_1.jsxs)(table_1.Table, { children: [(0, jsx_runtime_1.jsx)(table_1.TableHeader, { children: (0, jsx_runtime_1.jsxs)(table_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(table_1.TableHead, { children: "Provider" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { children: "Model" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { children: "Status" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { children: "Active" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { className: "text-right", children: "Runs" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { className: "text-right", children: "Calls" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { className: "text-right", children: "Input" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { className: "text-right", children: "Output" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { className: "text-right", children: "Total" }), (0, jsx_runtime_1.jsx)(table_1.TableHead, { className: "text-right", children: "Cost" })] }) }), (0, jsx_runtime_1.jsx)(table_1.TableBody, { children: rows.map((row) => ((0, jsx_runtime_1.jsxs)(table_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(table_1.TableCell, { children: (0, jsx_runtime_1.jsxs)("div", { className: "space-y-1", children: [(0, jsx_runtime_1.jsx)("div", { className: "font-medium", children: row.provider_label }), (0, jsx_runtime_1.jsx)("div", { className: "text-xs text-muted-foreground", children: row.api_key_env || '-' })] }) }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { children: row.model }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { children: (0, jsx_runtime_1.jsx)(badge_1.Badge, { variant: row.api_key_configured ? 'secondary' : 'destructive', children: row.api_key_configured ? 'Configured' : 'Missing env' }) }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { children: (0, jsx_runtime_1.jsx)(badge_1.Badge, { variant: row.current ? 'default' : 'outline', children: row.current ? 'Current' : 'Idle' }) }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { className: "text-right", children: row.runs }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { className: "text-right", children: row.llm_calls }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { className: "text-right", children: row.input_tokens.toLocaleString() }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { className: "text-right", children: row.output_tokens.toLocaleString() }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { className: "text-right", children: row.total_tokens.toLocaleString() }), (0, jsx_runtime_1.jsx)(table_1.TableCell, { className: "text-right", children: row.total_cost_usd == null ? 'N/A' : `$${row.total_cost_usd.toFixed(6)}` })] }, `${row.provider_id}:${row.model}`))) })] })) : ((0, jsx_runtime_1.jsx)("div", { className: "p-4 text-sm text-muted-foreground", children: "No model usage records." })) }) })] }));
}
function UsageMetricCard({ label, value }) {
    return ((0, jsx_runtime_1.jsx)(card_1.Card, { children: (0, jsx_runtime_1.jsxs)(card_1.CardContent, { className: "space-y-1 p-4", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-xs font-medium uppercase tracking-wide text-muted-foreground", children: label }), (0, jsx_runtime_1.jsx)("div", { className: "text-2xl font-semibold tracking-tight", children: value })] }) }));
}
function DonutChart({ share }) {
    if (!share.length) {
        return (0, jsx_runtime_1.jsx)("div", { className: "rounded-lg border border-dashed p-6 text-sm text-muted-foreground", children: "No usage data yet." });
    }
    const size = 220;
    const radius = 74;
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "grid gap-4 md:grid-cols-[220px_1fr]", children: [(0, jsx_runtime_1.jsx)("div", { className: "mx-auto flex w-[220px] items-center justify-center", children: (0, jsx_runtime_1.jsxs)("svg", { viewBox: `0 0 ${size} ${size}`, className: "h-[220px] w-[220px]", children: [(0, jsx_runtime_1.jsx)("circle", { cx: size / 2, cy: size / 2, r: radius, fill: "none", stroke: "hsl(var(--muted))", strokeWidth: strokeWidth }), segments.map((segment) => ((0, jsx_runtime_1.jsx)("circle", { cx: size / 2, cy: size / 2, r: radius, fill: "none", stroke: segment.color, strokeWidth: strokeWidth, strokeDasharray: `${segment.dash} ${segment.gap}`, strokeDashoffset: -segment.offset, strokeLinecap: "round", transform: `rotate(-90 ${size / 2} ${size / 2})` }, `${segment.provider_id}:${segment.model}`)))] }) }), (0, jsx_runtime_1.jsx)("div", { className: "space-y-2", children: segments.map((segment) => ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-3 rounded-lg border border-border/60 bg-muted/20 px-3 py-2", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3", children: [(0, jsx_runtime_1.jsx)("span", { className: "h-3 w-3 rounded-full", style: { backgroundColor: segment.color } }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { className: "text-sm font-medium", children: segment.model }), (0, jsx_runtime_1.jsx)("div", { className: "text-xs text-muted-foreground", children: segment.provider_id })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "text-right text-sm", children: [(0, jsx_runtime_1.jsxs)("div", { children: [Math.round(segment.share * 100), "%"] }), (0, jsx_runtime_1.jsxs)("div", { className: "text-xs text-muted-foreground", children: [segment.total_tokens.toLocaleString(), " tokens"] })] })] }, `${segment.provider_id}:${segment.model}`))) })] }));
}
function UsageLineChart({ series, timeline }) {
    const width = 720;
    const height = 260;
    const padding = 28;
    const allPoints = series.flatMap((item) => item.points.map((point) => point.total_tokens));
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "space-y-4", children: [(0, jsx_runtime_1.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, className: "h-[260px] w-full", children: [[0, 0.25, 0.5, 0.75, 1].map((ratio) => ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)("line", { x1: padding, x2: width - padding, y1: padding + ratio * (height - padding * 2), y2: padding + ratio * (height - padding * 2), stroke: "hsl(var(--border))", strokeDasharray: "4 4" }), (0, jsx_runtime_1.jsx)("text", { x: 4, y: padding + ratio * (height - padding * 2) + 4, className: "fill-muted-foreground text-[10px]", children: Math.round(maxValue * (1 - ratio)).toLocaleString() })] }, ratio))), timeline.map((point, index) => ((0, jsx_runtime_1.jsx)("text", { x: padding + index * xStep, y: height - 8, textAnchor: "middle", className: "fill-muted-foreground text-[10px]", children: point.label }, point.date))), series.map((item) => {
                        const points = item.points.map((point, pointIndex) => `${pointIndex === 0 ? 'M' : 'L'} ${padding + pointIndex * xStep} ${yScale(point.total_tokens)}`).join(' ');
                        return (0, jsx_runtime_1.jsx)("path", { d: points, fill: "none", stroke: item.color, strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round" }, `${item.provider_id}:${item.model}`);
                    })] }), (0, jsx_runtime_1.jsx)("div", { className: "flex flex-wrap gap-2", children: series.map((item) => ((0, jsx_runtime_1.jsxs)(badge_1.Badge, { variant: "outline", className: "gap-2", children: [(0, jsx_runtime_1.jsx)("span", { className: "h-2.5 w-2.5 rounded-full", style: { backgroundColor: item.color } }), item.model] }, `${item.provider_id}:${item.model}`))) })] }));
}
function ChartSkeleton() {
    return (0, jsx_runtime_1.jsx)("div", { className: "h-[260px] animate-pulse rounded-lg border border-dashed bg-muted/20" });
}
