...
def run_main(prompt: str, workspace: Path, session_id: Optional[str] = None, json_mode: bool = False, mode: str = "default") -> dict:
    agent = build_agent(workspace, session_id=session_id)
    ...
    payload = {
        ...
        "assistant": compact_text(_message_preview_for_agent(agent, "assistant", limit=400), limit=400),
...
if app:
    ...
    @app.command()
    def run(prompt: str = typer.Argument(..., help="Prompt to send to the agent."), workspace: Path = typer.Option(Path.cwd(), "--workspace", "-w"), session_id: Optional[str] = typer.Option(None, "--session"), json_mode: bool = typer.Option(False, "--json"), mode: str = typer.Option("default", "--mode")) -> None:
