...
def _normalize_trace(bot_id: str, channel: str, trace_id: str, trace_info: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "platform": trace_info.get("platform") or channel,
        "platform_event_id": trace_info.get("platform_event_id"),
        "platform_message_id": trace_info.get("platform_message_id") or trace_info.get("message_id"),
        "platform_user_id": trace_info.get("platform_user_id"),
        "channel_id": trace_info.get("channel_id"),
        ...
        "inbound_event_type": trace_info.get("inbound_event_type"),
        "outbound_send_result": trace_info.get("outbound_send_result"),
        "approval_token": trace_info.get("approval_token"),
        "tool_call_id": trace_info.get("tool_call_id"),
        "runtime_trace_run_id": trace_info.get("runtime_trace_run_id"),
        "parent_id": trace_info.get("parent_id") or trace_info.get("runtime_trace_run_id"),
