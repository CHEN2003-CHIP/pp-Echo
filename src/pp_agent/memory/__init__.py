...
_MODULE_MAP = {
    ...
    "CoreMemory": "pp_agent.memory.core_types",
    "CoreMemoryCandidate": "pp_agent.memory.core_types",
    "CoreMemoryStore": "pp_agent.memory.core_store",
    "CoreMemoryRenderer": "pp_agent.memory.core_renderer",
    "CoreMemoryService": "pp_agent.memory.core_service",
