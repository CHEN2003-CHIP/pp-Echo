...
_PRESETS: Dict[str, ProviderPreset] = {
    ...
    "xiaomi": ProviderPreset(
        ...
        recommended_models=["mimo-v2.5-pro", "mimo-v2.5", "mimo-v2-pro", "mimo-v2-omni", "mimo-v2-flash"],
        supports_thinking=True,
        supports_tools=True,
        notes="MiMo exposes an OpenAI-compatible /chat/completions API; use MIMO_API_KEY for authentication.",
    ),
