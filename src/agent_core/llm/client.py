...
from agent_core.types import ChatMessage, ContentPart, ModelConfig, ProviderConfig, TextPart, ToolCallPart
...
class LLMClient:
    def __init__(
        ...
        self.provider = provider or ProviderConfig(
            base_url=os.getenv("PP_AGENT_BASE_URL", "https://dashscope.aliyuncs.com/compatible-mode/v1")
        )
        self.model = model or ModelConfig(model=os.getenv("PP_AGENT_MODEL", "qwen3.5-plus"))
